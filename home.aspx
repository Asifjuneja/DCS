                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbar-collapse-4">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li>
                                <asp:Button ID="btnprofile" OnClick="btnprofile_Click" CssClass="btn btn-default btn-outline btn-circle" ForeColor="White" data-toggle="collapse" aria-expanded="false" runat="server" Text="Profile" />
                            </li>

                            <li>
                                <asp:Button ID="btnlogout" CssClass="btn btn-default btn-outline btn-circle" ForeColor="White" data-toggle="collapse" aria-expanded="false" runat="server" OnClick="btnlogout_Click" Text="Logout" />
                            </li>
                        </ul>
                    </div>
                </div>
